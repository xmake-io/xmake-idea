...
object TargetPathResolver {
     ...
     * default binary target). Returns null when no toolkit is activated, the script is missing, or
     * the target produces no binary. Runs the probe synchronously.
     */
    fun resolve(project: Project, targetName: String): String? {
        ...
        project.activatedToolkit ?: return null
